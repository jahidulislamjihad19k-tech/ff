...
uid=426314305,password=2336099414_W0363_BY_XANAF_GAMING_WBYMF

# OR Format 2: Line-separated
# uid: 4263143059
# password: 2336099414_W0363_BY_XANAF_GAMING_WBYMF
...
🤖 Bot Name: XANAF_LEGANCY
✅ Status: Ready to join

📱 Player will see:
"XANAF_LEGANCY wants to join your team"
...
async def black666(client_id, key, iv):
    banner_text = "[FF0000][B][C] ERROR , WELCOME TO [FFFFFF]XANAF LEGACY[00FF00]___X³____ BOT ! \n[FFFF00]NEW VERSION NEW FUNCTION !\n[FF0000]TELEGRAM : @XAHAF_LEGACY\n\n"     
    fields = {
        1: 5,
        2: {
            1: int(client_id),
...
Region: {server_name}
[FFDD00]°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°°
[00FF00][b][c]BOT MADE BY XAHAF_LEGACY 
"""
            else:
...
[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]
[FFD700] ＦＯＬＬＯＷ    ＭＥ   ＩＮ   [87CEEB]TELEGRAM: [FF0000]@XAHAF_LEGACY_GAMER
[FF0000]━[00FF00]━[0000FF]━[FFFF00]━[FF00FF]━[00FFFF]━[FFA500]━[FF1493]━[00FF7F]━[FFD700]━[00CED1]━[9400D3]━[FF6347]━[32CD32]━[7B68EE]━[FF4500]━[1E90FF]━[ADFF2F]━[FF69B4]━[8A2BE2]━[DC143C]━[FF8C00]━[BA55D3]━[7CFC00]━[FFC0CB]"""
    fields = {
    1: 5,
    2: {
...
async def noob(target_uid, chat_id, key, iv, nickname="XAHAF_LEGACY", title_id=None):
    """EXACT conversion with customizable title ID"""
    try:
        # Use provided title_id or get random one
        if title_id is None:
...
async def send_all_titles_sequentiallly(uid, chat_id, key, iv, region, chat_type):
    ...
    # Send initial message
    start_msg = f"""[B][C][00FF00] Noobde XAHAF_LEGACY ya meku agar tu noob bolra toh tu g a y hai
...
"""
    ...
    try:
        for index, title_id in enumerate(all_titles):
            ...
            # You'll need to use your existing title sending logic here
            # For example:
            title_packet = await noob(uid, chat_id, key, iv, nickname="XAHAF_LEGACY", title_id=title_id)
              ...
              # =================== EMOTE DETECTION ONLY ===================
                    ...
                    try:
                        ...
                        if "1234567890" in WHITELISTED_UIDS:
                            ...
                            try:
                                ...
                                bot_uid = 13777711848
                                message_text = f" Can't accept Your request Talk to XAHAF_LEGACY"
                ...
                if insquad == True:
                    try:
                        ...
                        message = """[B][C][FF0000]█▓▒░░ WELCOME TO BD71 ░░▒▓█
[00FF00]»»————-　★　————-««
[FFFFFF]⚡ BOT POWERED BY:[FF0000]X³
[FFFFFF]🎯 STATUS: [00FF00]ACTIVE 24/7
[FFFFFF]📱 CONTACT: [FFFF00]@XAHAF_LEGACY
[00FF00]»»————-　★　————-««
...
📝 Examples:
/bio Hello World!
/bio 🤖 Bot by XAHAF LEGACY
/bio Level 70 | Pro Player
/bio Add me: XAHAF_LEGACY
...
👥 Whitelisted UIDs:"""
                            ...
                            for uid in WHITELISTED_UIDS:
                                if uid != "14270700700":  # Skip owner since already shown
                                    whitelist_msg += f"\n• {xMsGFixinG(uid)}"
                                    count += 1
                                    if count >= 20:
...
[b][i][FFC0CB]youtube: @XAHAF_LEGACY 99[/b]

[b][c][FFC0CB]subcribe: my_channel[FFFFFF]
 
[b][i][FFA500]telegram: @@XAHAF_LEGACY[/b]

[b][c][FFA500]telegram contact: @@XAHAF_LEGACY[A52A2A]
 
Enjoy the bot my friend.......

[C][B][0000FF] Created by Black666FF
Modified by - XAHAF_LEGACY
"""
...
async def MaiiiinE():
    ...
    os.system('clear')
    print("=" * 50)
    print("🤖 XAHAF LEGACY BOT - INITIALIZING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 XAHAF LEGACY BOT - STARTING")
    print("=" * 50)
    ...
    os.system('clear')
    print("🤖 XAHAF LEGACY BOT - CONNECTING")
    print("=" * 50)
    print("┌────────────────────────────────────┐")
    print("│ ██████████████████████████████████ │")
    print("└────────────────────────────────────┘")
