...
async def xSEndMsg(Msg , Tp , Tp2 , id , K , V):
    feilds = {1: id , 2: Tp2 , 3: Tp, 4: Msg, 5: 1735129800, 7: 2, 9: {1: "Delta Rare Exe", 2: int(await xBunnEr()), 3: 901048018, 4: 330, 5: 909034009, 8: "Delta Rare Exe", 10: 1, 11: 1, 13: {1: 2}, 14: {1: 12484827014, 2: 8, 3: "\u0010\u0015\b\n\u000b\u0013\f\u000f\u0011\u0004\u0007\u0002\u0003\r\u000e\u0012\u0001\u0005\u0006"}, 12: 0}, 10: "en", 13: {3: 1}}
...
async def xSEndMsgsQ(Msg , id , K , V):
    fields = {1: id , 2: id , 4: Msg , 5: 1756580149, 7: 2, 8: 904990072, 9: {1: "Delta Rare Exe", 2: await xBunnEr(), 4: 330, 5: 827001005, 8: "Delta Rare Exe", 10: 1, 11: 1, 13: {1: 2}, 14: {1: 1158053040, 2: 8, 3: "\u0010\u0015\b\n\u000b\u0015\f\u000f\u0011\u0004\u0007\u0002\u0003\r\u000e\u0012\u0001\u0005\u0006"}}, 10: "en", 13: {2: 2, 3: 1}}
...
async def SEnd_InV_Enhanced(target_uid, bot_uid, K, V, region="bd", name="DELTA SPM", badge=330, level=99, rank=21, banner_id=902000306, avatar_id=909034009):
    """Enhanced invite packet with Badge, Rank, Level, Name support"""
...
async def OpEnSq_Enhanced(K, V, region="bd", name="DELTA SPM", badge=330, level=99):
    """Enhanced open squad packet with custom name/badge"""
    fields = {
        1: 1, 
        2: {
            2: "\u0001", 
...
# =================== BUNDLE PACKET FUNCTION ===================
async def bundle_packet_async(bundle_id, K, V, region):
    """Create bundle packet for sending bundle items"""
    fields = {
        1: 88,
        2: {
            1: {
    ...
    # Generate and return packet
    return await GeneRaTePk((await CrEaTe_ProTo(fields)).hex(), packet_type, K, V)


# =================== RANK/BANNER/AVATAR PACKET FUNCTIONS ===================
async def rank_packet_async(rank_id, K, V, region):
    """Create rank packet"""
    fields = {
        1: 89,  # Rank packet type
        2: {
            1: int(rank_id)
        }
    }
...
async def banner_packet_async(banner_id, K, V, region):
    """Create banner packet"""
    fields = {
        1: 90,  # Banner packet type
        2: {
            1: int(banner_id)
        }
    }
...
async def avatar_packet_async(avatar_id, K, V, region):
    """Create avatar packet"""
    fields = {
        1: 91,  # Avatar packet type
        2: {
            1: int(avatar_id)
        }
    }
