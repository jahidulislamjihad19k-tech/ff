...
async def bundle_command_operation(ctx: BotContext, bundle_name: str):
    ...
    try:
        ...
        if bundle_name_lower not in bundle_ids:
            ...
            return False, f"❌ Invalid bundle name!\n\nAvailable: {available}"
        ...
        if bundle_packet and ctx.online_writer:
            ...
            return True, f"✅ Bundle '{bundle_name}' sent successfully!"
        else:
            return False, "❌ Failed to create or send bundle packet"
            
    except Exception as e:
        return False, f"❌ Error in bundle command: {str(e)}"
